...
SENDER_SOURCES = $(wildcard src/sender.c src/log.c src/lib/sendData/real_address.c src/lib/sendData/create_socket.c src/lib/sendData/read_write_loop_sender.c src/lib/segment/packet_implem.c src/lib/queue/queue.c)
RECEIVER_SOURCES = $(wildcard src/receiver.c src/log.c src/lib/sendData/create_socket.c src/lib/sendData/wait_for_client.c src/lib/sendData/real_address.c src/lib/sendData/read_write_loop_server_v2.c src/lib/segment/packet_implem.c src/lib/sortedList/sortedList.c)
