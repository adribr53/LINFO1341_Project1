...
dd if=/dev/urandom of=input_file bs=1 count=5120 &> /dev/null
...
../receiver localhost 2456 1>received_file 2> recv.log &
receiver_pid=$!
...
if ! ../sender localhost 1341 <input_file 2>send.log ; then
